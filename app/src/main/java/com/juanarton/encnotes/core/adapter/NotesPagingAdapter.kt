...
class NotesPagingAdapter (
...
) : PagingDataAdapter<Notes, NotesPagingAdapter.ViewHolder>(NotesComparator) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotesPagingAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: NotesPagingAdapter.ViewHolder, position: Int) {
